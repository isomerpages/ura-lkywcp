...
How can cities then adjust themselves to these long-term changes? What are the flaws and gaps that COVID-19 has exposed that need urgent addressing more than ever? And how can cities prepare themselves for long-term inclusive recovery in a world compounded by the ever-increasingly urgency of climate change issues? The Lee Kuan Yew World City Prize Nominating Committee members gathered in a virtual roundtable to share their views on the issues of the changing nature of work, social equity, and urban resilience. 
