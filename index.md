...
sections:
    ...
    - infobar:    
        ...
        description: <i><span style="font-family: Georgia, serif">"Through the collective efforts of all cities around the world, we can aspire to learn from one another and truly make an impact in creating a better place for ourselves, and our future generations."</span></i>
        button: 
        url: 
    - infopic:    
